...
**Status:** F1 and F2 were fixed in the commit that follows this one; everything
else in §2 is open. The findings are left exactly as written — this is the record
of one run, not a checklist to work through.
